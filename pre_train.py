...
parser.add_argument(
    "--test-file", type=str, default="/home/icdm/icdm2022_large/test_session1_ids.csv"
)
parser.add_argument("--json-file", type=str, default="pyg_pred_ycc.json")
...
if args.inference:
    model = torch.load(osp.join("./best_model", args.model_id + "ll2.pth"))
else:
    model = RGCN(
...
if args.inference == False:
    ...
    for epoch in range(1, args.n_epoch + 1):
        ...
        # if epoch == 1:
        #     torch.save(model, osp.join("./best_model", args.model_id + "epoch1.pth"))
        if args.validation and epoch >= args.early_stopping:
            ...
            if val_ap <= ave_val_ap:
                ...
                break
            torch.save(model, osp.join("./best_model", args.model_id + "ll2.pth"))
