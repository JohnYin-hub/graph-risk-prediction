...
# pyg_data_session1="/data1/competition/icdm/data__ycc"
...
# python rgcn_ycc.py --dataset  $pyg_data_session1".pt" \
#               --h-dim 10 \
#               --n-bases 8 \
#               --n-layers 2 \
#               --fanout 50 \
...
python rgcn_ycc2.py --dataset "/data1/competition/icdm/data/icdm.pt" \
                --h-dim $h_dim \
                --n-bases $n_bases \
                --n-layers $num_layers \
                --fanout $fanout \
...
# python rgcn_ycc2.py --dataset "/data1/competition/icdm/data/icdm_new.pt" \
#         --test-file "/data1/competition/icdm/data/icdm2022_session2_test_ids.txt" \
#         --json-file "./result/pyg_pred_session2.json" \
#         --batch-size $batch_size \
#         --n-layers $num_layers \
#         --fanout $fanout \
#         --inference True \
